...
import logo from "../../image/fb-logo.jpeg";
        ...
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-start space-x-3">
              ...
              >
                {" "}
                <AiFillFacebook className="text-3xl text-gray-200 mr-3"></AiFillFacebook>
              </a>

              <a
                href="https://www.linkedin.com/in/md-sayem-miah/"
                target="_blank"
                rel="noreferrer"
              >
                {" "}
                <AiFillLinkedin className="text-3xl text-gray-200 mr-3"></AiFillLinkedin>
              </a>
              ...
              >
                {" "}
                <AiFillGithub className="text-3xl text-gray-200"></AiFillGithub>
              </a>
            </div>
          </div>
        </div>
